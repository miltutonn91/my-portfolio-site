...
const works: Work[] = [
  {
    ...
    detail:
      "実店舗を持たず、現在は受注生産を中心に活動されているクライアントに向けて、今後のEC展開を見据えたブランディングサイトを制作しました。スマホファーストで操作性を意識し、同時制作したECサイトと紐づけることで、ブランド全体として統一感のある世界観を表現しました。",
...

  {
    ...
    detail:
      "転職活動のためのポートフォリオサイトを制作しました。採用担当者の方の視点を意識し、作品の魅力や自身の制作姿勢が伝わるよう、情報整理と導線設計を行いました。Next.js と TypeScript を使用し、操作性や保守性にも配慮して実装しました。",
...

  {
    ...
    detail:
      "デザインカンプをもとに、実務に近いコーディング力を高めることを目的に制作しました。デザインの再現性に加え、レスポンシブ対応やUI表現の細部まで丁寧に調整し、ユーザビリティを意識した実装を行いました。",
