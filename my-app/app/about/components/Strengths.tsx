...
const strengths = [
  ...
  },
  {
    number: "2",
    title: "洞察力",
    body: "看護師として、患者のわずかな変化や兆候を正確に捉え、根拠をもって判断・対応する力を磨いてきました。その経験から、状況を多角的に観察し、問題の本質を見極める力が培われたと感じています。Web制作においてもその視点を活かし、デザインやコードの不整合・使いづらさを早期に発見し、改善へとつなげています。ユーザーとチーム双方の視点から、全体として機能する構造と体験を意識した実装を目指しています。",
  },
  {
    number: "3",
    title: "探究心",
