  ...
  return (
    <article className="group relative">
      ...
      <div className="relative mt-5">
        <div className="mb-3">
          <span className="text-[0.75rem] font-medium tracking-[0.1em] text-[#9ABCB7] md:text-[0.875rem]">
            {description}
          </span>
        </div>
        ...
        <div className="mt-5 flex flex-col gap-4">
          ...
          {detailLink && (
            <div className="flex justify-end">
              <Link
                href={detailLink}
                className="group/detail inline-flex cursor-pointer items-center gap-1.5 pb-1 text-[0.75rem] tracking-[0.12em] text-[#5F5555] transition duration-300 hover:text-[#A28686]"
              >
                <span className="relative">
                  詳しくみる
                  <span className="absolute -bottom-1 left-0 h-px w-full origin-left scale-x-100 bg-[#A28686]/60 transition-transform duration-300 group-hover/detail:scale-x-110" />
                </span>
