...
export default function FV() {
  ...
  <span className="fv-title-trace fv-title-trace--first block">
    Misa Umeda&apos;s
  </span>

  <span className="fv-title-trace fv-title-trace--second block">
    Portfolio
  </span>
</p>

                <div className="fv-title-sub mt-4 flex w-full items-center gap-3">
