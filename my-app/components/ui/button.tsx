  ...
  return (
    <Comp
      className={cn(
        ...
        // サイズ
        size === "sm" &&
          "gap-1.5 px-3.5 py-1.5 text-[0.75rem] tracking-[0.08em]",
        size === "md" && "gap-2 px-5 py-2 text-[0.8125rem] tracking-[0.08em]",
        size === "lg" && "gap-2.5 px-7 py-3 text-[0.875rem] tracking-[0.1em]",
